...
import { resumeDownloadUrl } from "@/lib/site";
...
export default function QuickPage() {
  return (
    <div className="quick-page page-shell">
      <section className="quick-hero"><p className="pixel-label">RECRUITER% SPEEDRUN</p><div><h1>Ali Sufiyan Khan</h1><span className="quick-timer mono">00:60</span></div><p>Computer Science undergraduate building applied AI, robotics, and distributed infrastructure. Graduating from VIT Vellore in May 2027.</p><div className="hero__actions"><a className="button button--primary" href={resumeDownloadUrl} download data-umami-event="resume-download" data-umami-event-location="quick-view">Download résumé <Download size={17} /></a><a className="button button--ghost" href="mailto:alizaydsab@gmail.com">Email Ali <Mail size={17} /></a></div></section>
